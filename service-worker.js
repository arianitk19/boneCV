...
self.addEventListener('install', (event) => {
  event.waitUntil((async () => {
    ...
    // accepts the in-app "Update" toast (SKIP_WAITING message). This keeps
    // updates consensual and prevents a surprise mid-session reload.
  })());
});
...
async function cacheFirst(req, cacheName) {
  ...
  try {
    ...
    // Never resolve with undefined — respondWith(undefined) throws.
